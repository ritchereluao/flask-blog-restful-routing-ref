...
def add_new_post():
    ...
    if create_post.validate_on_submit():
        new_blog_post = BlogPost(title=create_post.title.data,
    ...
    return render_template("make-post.html", form=create_post)


@app.route("/edit-post/<int:post_id>", methods=["GET", "POST"])
def edit_post(post_id):
    post = BlogPost.query.get(post_id)
    edit_form = CreatePostForm(title=post.title, subtitle=post.subtitle, author=post.author,
